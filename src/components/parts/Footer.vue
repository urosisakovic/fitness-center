<template>
  <footer class="container-fluid bg-steel page-footer font-small blue pt-4">
    <div class="text-center text-md-left">
      <div class="row">
        ...
        <div class="col-md-3 mb-md-0 mb-3">
          ...
          <ul class="list-unstyled">
            <li>
              <router-link :to="makeLanguageRoute(homeLink)" class="foot-link">{{ words.home }}</router-link>
            </li>
            <li>
              <router-link :to="makeLanguageRoute(aboutLink)" class="foot-link">{{ words.aboutus }}</router-link>
            </li>
            <li>
              <router-link
    ...
    <div class="footer-copyright text-center">
      © 2020, Nikola Barjaktarevic, Uros Isakovic
      <br />
      {{ words.copyright }}
    </div>
  </footer>
