    ...
    <ul class="list-unstyled components">
      <li>
        <a
          ...
          aria-expanded="false"
          class="dropdown-toggle-sb"
        >{{ words.Yoga }}</a>
        <ul class="collapse list-unstyled" id="yoga-submenu">
          <li>
            <router-link :to="makeLanguageRoute(yogaLink)">{{ words.Yoga }} {{ words.Schedule }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(yogaLink1)">{{ words.yoga1 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(yogaLink2)">{{ words.yoga2 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(yogaLink3)">{{ words.yoga3 }}</router-link>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="collapse list-unstyled" id="pilates-submenu">
          <li>
            <router-link
              :to="makeLanguageRoute(pilatesLink)"
            >{{ words.Pilates }} {{ words.Schedule }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(pilatesLink1)">{{ words.pilates1 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(pilatesLink2)">{{ words.pilates2 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(pilatesLink3)">{{ words.pilates3 }}</router-link>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="collapse list-unstyled" id="core-submenu">
          <li>
            <router-link :to="makeLanguageRoute(coreLink)">{{ words.Core }} {{ words.Schedule }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(coreLink1)">{{ words.core1 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(coreLink2)">{{ words.core2 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(coreLink3)">{{ words.core3 }}</router-link>
          </li>
        </ul>
      </li>
      ...
      <li>
        ...
        <ul class="collapse list-unstyled" id="cardio-submenu">
          <li>
            <router-link :to="makeLanguageRoute(cardioLink)">{{ words.Cardio }} {{ words.Schedule }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(cardioLink1)">{{ words.cardio1 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(cardioLink2)">{{ words.cardio2 }}</router-link>
          </li>
          <li>
            <router-link :to="makeLanguageRoute(cardioLink3)">{{ words.cardio3 }}</router-link>
          </li>
        </ul>
      </li>
    </ul>
